    ...
    <MainTemplate headerAnimation={false} minHeight={true}>
      ...
      >
        <div style={{ lineHeight: '1.8', color: '#333' }}>
          ...
          <p style={{ marginBottom: '10px' }}>3.1. Оператор имеет право:</p>
          ...
          <p style={{ marginBottom: '10px' }}>3.2. Оператор обязан:</p>
          <ul style={{ marginLeft: '30px', marginBottom: '15px' }}>
            <li style={{ marginBottom: '8px' }}>
          ...
          <p style={{ marginBottom: '10px' }}>5.1. Фамилия, имя, отчество.</p>
          <p style={{ marginBottom: '10px' }}>5.2. Электронный адрес.</p>
          <p style={{ marginBottom: '10px' }}>5.3. Номера телефонов.</p>
          <p style={{ marginBottom: '10px' }}>
          ...
          <ul style={{ marginLeft: '30px', marginBottom: '15px' }}>
            ...
            <li style={{ marginBottom: '8px' }}>
              ...
              материалам, содержащимся на веб-сайте https://nampoputi.rent/.
            </li>
          </ul>
          <p style={{ marginBottom: '10px' }}>
            ...
            электронной почты info@nampoputi.rent с пометкой «Отказ от
          ...
          <p style={{ marginBottom: '10px' }}>
            ...
            https://nampoputi.rent/ или направленные Оператору посредством
          ...
          <p style={{ marginBottom: '10px' }}>
            ...
            Оператора info@nampoputi.rent с пометкой «Актуализация персональных
            данных».
          </p>
          <p style={{ marginBottom: '10px' }}>
            ...
            info@nampoputi.rent с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          <p style={{ marginBottom: '10px' }}>
          ...
          <p style={{ marginBottom: '10px' }}>
            ...
            к Оператору с помощью электронной почты info@nampoputi.rent.
          </p>
          <p style={{ marginBottom: '10px' }}>
          ...
          <p style={{ marginBottom: '30px' }}>
            ...
            сети Интернет по адресу https://nampoputi.rent/privacy/.
          </p>
        </div>
      </div>
    </MainTemplate>
