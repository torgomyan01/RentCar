...
const PHYSICAL_DOCS = [
  {
    text: 'Общегражданский паспорт РФ. Обязательно наличие постоянной регистрации.',
  },
  {
...
const LEGAL_DOCS = [
  {
    text: 'Карточка юридического лица',
  },
  {
    text: 'Водительское удостоверение на каждого водителя',
  },
  {
    text: 'Паспорт на каждого водителя',
  },
  {
    text: 'Доверенность на право заключения договора аренды (если подписант не является руководителем)',
  },
  {
    text: 'Паспорт доверенного лица (если подписант не является руководителем)',
  },
];
        ...
        <div className="top-info">
          <div className="texts">
            ...
            <p className="text">
              ...
              безналичным расчетом. Прописка в Москве и Московской области не
              требуется.
            </p>
          </div>
          <div className="buttons" role="tablist">
            ...
            <button
              ...
              aria-controls="documents-panel"
              id="tab-legal"
              className={clsx(activeTab === 'legal' ? 'red-btn' : 'border-btn')}
